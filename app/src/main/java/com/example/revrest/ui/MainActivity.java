package com.example.revrest.ui;
...
import com.example.revrest.R;
import com.example.revrest.data.response.CustomerReviewsItem;
import com.example.revrest.data.response.PostReviewResponse;
import com.example.revrest.data.response.Restaurant;
import com.example.revrest.data.response.RestaurantResponse;
import com.example.revrest.data.retrofit.ApiConfig;
